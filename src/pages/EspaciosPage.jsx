...
export default function EspaciosPage() {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto space-y-8">
      {/* Título */}
      <div className="flex items-center justify-between bg-gradient-to-r from-blue-50 to-purple-50 p-6 rounded-2xl border border-blue-200/50 shadow-sm">
        ...
        <div className="text-right max-w-md">
          <p className="text-sm text-gray-500 bg-white/80 px-4 py-2 rounded-lg border border-gray-200/50 shadow-sm">
            <span className="font-semibold text-blue-600">📊</span> Explora y filtra los espacios por medio, categoría o alcance
          </p>
        </div>
      </div>
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-16 space-y-4">
            ...
            //*<div className="text-center">
              <p className="text-lg font-semibold text-gray-700">Cargando espacios publicitarios</p>
              <p className="text-sm text-gray-500 mt-1">Estamos preparando tu información...</p>
            </div>
          </div>
        ) : (
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-400/10 to-purple-400/10 rounded-3xl blur-sm"></div>
